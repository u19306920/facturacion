...
class Ordenes extends Conexion {
    ...
    public function ordenes(){
        $resultado = $this->mysqli->query("
            ...
            ORDER BY fecha_emision desc , ordenes.creado DESC");
    ...
    //*****************************************************************
    // MODIFICAR ORDEN CORRELATIVO
    //*****************************************************************
    public function update_correlativo($correlativo,$orden,$idordenes) {
        ...
        $consulta = sprintf(
            ...
            WHERE
            idordenes = %s;",
            parent::comillas_inteligentes($correlativo),
            parent::comillas_inteligentes($orden),
            parent::comillas_inteligentes($idordenes)
            );
    ...
    // ORDENES POR AÑO
    //*****************************************************************
    public function ordenPorAnio($id){
        $consulta = sprintf("
            SELECT
            ordenes.idordenes,
            ordenes.fecha_emision,
