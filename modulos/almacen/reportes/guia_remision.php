...
//Direccion Fiscal
$pdf->SetXY(27,$y+74);
$pdf->Cell(93,4,ucwords(substr(strtolower(utf8_decode($cliente[0]['direccion_fiscal'])),0,70)),$borde);
//Punto de Llegada
$pdf->SetXY(35,$y+80);
$pdf->Cell(85,4,ucwords(substr(strtolower(utf8_decode($guia[0]['destino'])),0,70)),$borde);
//RUC
$pdf->SetXY(30,$y+87);
...
foreach ($Items as $key) {
	...
	//Unidad de Medida
	$pdf->SetXY(18,$y+140+$altura);
	$pdf->Cell(8,4,utf8_decode($Is[0]['um']),$borde,0,'C');
	//Descripcion de Item
	$pdf->SetXY(40,$y+140+$altura);
