                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-pane-1" role="tab"
                       aria-controls="tab-pane-1" aria-selected="true"><i class="fas fa-file"></i> Listado de Tipo de Cambio
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-pane-2" role="tab"
                       aria-controls="tab-pane-2" aria-selected="true"><i class="icon icon-add"></i> Nuevo Tipo de Cambio
                    </a>
                  </li>
                </ul>
                <!-- /tab navigation -->
                            ...
                            <table id="data-table2" class="table table-hover dataTable dtr-inline">
                              ...
                              <tbody>
                                <?php
                                  ...
                                  $tipos_cambios = $objTipoCambio->tipos_cambios();
                                  if($tipos_cambios > 0){
                                    $i=0;
                                ...
                                <tr class="gradeX">
                                  <td><?=$i?></td>
                                  <td><?=$tipo_cambio['fecha']?></td>
                                  <td><?=$tipo_cambio['compra']?></td>
                                  <td><?=$tipo_cambio['venta']?></td>
                                  <td><?=$tipo_cambio['registrado']?></td>
                                  <td>
                                    <a title="Editar" href="?module=configuracion&page=tipo_cambio_editar&id=<?=$tipo_cambio['idtipo_cambio']?>" ><i class="fa fa-fw fa-pen"></i></a>
