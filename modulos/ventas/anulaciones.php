            ...
            <div class="dt-card">
              ...
              <div class="dt-card__header">
                ...
                <div class="dt-card__heading">
                  <h3 class="dt-card__title">Anulaciones de Comprobantes</h3><!--Titulo-->
                </div>
                <!-- /card heading -->
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-pane-1" role="tab"
                       aria-controls="tab-pane-1" aria-selected="true"><i class="icon icon-user-o icon-xl"></i> Anulaciones
                    </a>
                  </li>
                  <li class="nav-item">
