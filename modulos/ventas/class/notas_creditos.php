...
class Notas_Creditos extends Conexion {
    ...
    //*****************************************************************
    // TIPO DE NC POR TIPO DOCUMENTO
    //*****************************************************************
    public function NcPorIdtipo($tipo){
        $consulta = sprintf("SELECT
            comprobantes_series.idcomprobantes_series,
            ...
            WHERE
            comprobantes_series.tipo_documento = %s
            ",
            parent::comillas_inteligentes($id)
            );
