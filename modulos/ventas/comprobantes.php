                            ...
                            <div class="table-responsive">
                              <table id="data-table" class="table table-hover dataTable dtr-inline">
                                ...
                                <tr class="gradeX">
                                  ...
                                  <td>
                                    <a href="<?=$_SESSION['url']?>/print/document/<?=$key['observaciones']?>/a4" title="Ver" class="btn btn-xs btn-info" target="_blank"><i class="fas fa-eye"></i></a>
                                  ...
                                  <td align="center">
                                    <ul class="dt-nav">
                                      <li class="dt-nav__item dropdown">
                                        <a class="btn btn-xs btn-info" href="<?=$_SESSION['url']?>/print/document/<?=$key['observaciones']?>/a4" title="Ver" target="_blank">
