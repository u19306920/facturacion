                          ...
                          <tbody>
                              ...
                              foreach ($_SESSION['carrito'] as $linea){
                                ...
                                */
                                foreach ($detalle2 as $key) {
                                  ...
                                  $_SESSION["items"][]=array('idordenes_detalles'=>$key['idordenes_detalles'],'cantidad'=>$saldo);
                            ...
                            ?>
                                <tr class="gradeX">
                                  ...
                                  <td><?=$key['moneda']?></td>
                                  <td style="text-align: right;"><?=number_format(round($saldo*$key['valor_unitario'],2,PHP_ROUND_HALF_UP),'2','.',',')?></td>
                                </tr>
                            <?php
